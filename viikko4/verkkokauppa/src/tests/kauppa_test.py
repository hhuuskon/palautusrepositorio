...
class TestKauppa(unittest.TestCase):
    ...
    def test_tehdaan_ostos_tuotteesta_jota_on_varastossa(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()

        # palautetaan aina arvo 42 (viitenumero)
        viitegeneraattori_mock.uusi.return_value = 42
    ...
    def test_tehdaan_ostos_kahdesta_tuotteesta_jota_on_varastossa(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tehdaan_ostos_kahdesta_samasta_tuotteesta_jota_on_varastossa(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tehdaan_ostos_jossa_kaikkia_tuotteita_ei_ole_varastossa(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_asioinnin_alussa_nollataan_tiedot(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tuote_palautuu_ostoskorista_varastoon_jos_se_poistetaan(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
